...
@section('breadcrumb', 'Master > Topik > Edit')
...
<div class="card">
    <div class="card-body pt-3">
        <form method="POST" action="{{ route('topik.update', $topik) }}">
            @csrf @method('PUT')
            <div class="row g-3">
                ...
                <div class="col-12">
                    <small class="text-muted">
                        Dibuat: {{ $topik->created_at->format('d-m-Y H:i') }}
                        &nbsp;·&nbsp;
                        Diperbarui: {{ $topik->updated_at->format('d-m-Y H:i') }}
                    </small>
                </div>
